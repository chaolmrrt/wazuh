...
static void test_fim_registry_process_value_event_ignore_event(void **state) {
    ...
    // Test if the entry is not configured
    registry_ignore ignore_conf[] = { { "valuename", ARCH_32BIT}, { "valuename", ARCH_64BIT}, { NULL, 0} };
    ...
    registry_ignore empty_ignore_conf[] = { { NULL, 0} };
    syscheck.value_ignore = empty_ignore_conf;
}
